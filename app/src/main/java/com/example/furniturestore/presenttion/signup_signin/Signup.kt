            ...
            )
            {
                Column(modifier = Modifier.fillMaxSize()) {
                    ...
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                ...
                                buildAnnotatedString {
                                    withStyle(
                                        ...
                                        withStyle(
                                            ...
                                            append(" Furniture to Life with AR")
                                        }
                                    }
                                }
                            )
                        ...
                        Text(
                            text = "No more guesswork—see how it fits before making \na move, designing your space with confidence..",
                            color = Color.Black,
                            fontSize = 14.sp,
                        ...
                        Row(
                            ...
                            Text(
                                ...
                                color = Color(0xFf18181A),
                                fontWeight = FontWeight.Bold,
                                modifier = Modifier.clickable {navController.navigate("OTPVerification")}
                            )
                        }
                    }
                }
